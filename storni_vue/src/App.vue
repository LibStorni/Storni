   ...
   <div id="wrapper">
    <nav class="navbar is-danger">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>Storni</strong></router-link>
          ...
          <div class="navbar-item">
            <div class="buttons">
              <template v-if="$store.state.isAuthenticated">
                <router-link to="/myaccount" class="button is-light">Mi cuenta</router-link>
              </template>
...
.lds-dual-ring::after{
    ...
    border-radius: 50%;
    border-color :  #ffc0cb transparent #ffc0cb transparent;
